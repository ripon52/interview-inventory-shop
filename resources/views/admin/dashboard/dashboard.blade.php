...
@section("heading", userType()." Dashboard")
...
@section("content")
    <div class="row">
        ...
        {{--                                        </div>--}}
        {{--                                        <img src="{{ asset('adminFiles') }}/images/menus/9.png" alt="" width="60" class="rounded">--}}
        {{--                                    </div>--}}
        {{--                                    <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">--}}
        ...
        {{--                                            <span class="text-black font-w600 d-inline-block mr-3">$5.6 </span> <span class="fs-14">Order 89x</span>--}}
        {{--                                        </div>--}}
        {{--                                        <img src="{{ asset('adminFiles') }}/images/menus/10.png" alt="" width="60" class="rounded">--}}
        {{--                                    </div>--}}
        {{--                                    <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">--}}
        ...
        {{--                                            <span class="text-black font-w600 d-inline-block mr-3">$5.6 </span> <span class="fs-14">Order 89x</span>--}}
        {{--                                        </div>--}}
        {{--                                        <img src="{{ asset('adminFiles') }}/images/menus/11.png" alt="" width="60" class="rounded">--}}
        {{--                                    </div>--}}
        {{--                                    <div class="d-flex pb-3 mb-3 border-bottom tr-row align-items-center">--}}
        ...
        {{--                                            <span class="text-black font-w600 d-inline-block mr-3">$5.6 </span> <span class="fs-14">Order 89x</span>--}}
        {{--                                        </div>--}}
        {{--                                        <img src="{{ asset('adminFiles') }}/images/menus/12.png" alt="" width="60" class="rounded">--}}
        {{--                                    </div>--}}
...
@section("scripts")
    <script src="{{ asset('adminFiles') }}/js/dashboard/dashboard-1.js"></script>
@endsection
